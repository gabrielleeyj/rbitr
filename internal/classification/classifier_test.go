...
func TestClassify(t *testing.T) {
	...
	cases := []struct {
		...
		{
			name:         "jira archive issue",
			toolID:       "jira",
			method:       "POST",
			path:         "/rest/api/3/issue/ABC-123/archive",
			query:        "",
			expectedType: "TICKET.UPDATE",
			expectedRisk: RiskLow,
			expectedSum:  "Update Jira issue",
		...
		},
		{
			...
			expectedType: "DATA.QUERY",
			expectedRisk: RiskLow,
			expectedSum:  "Query Jira board",
		},
		{
			name:         "jira agile query sprints",
			toolID:       "jira",
			method:       "GET",
			...
			expectedType: "DATA.QUERY",
			expectedRisk: RiskLow,
			expectedSum:  "Query sprints",
		},
		{
			name:         "jira agile create sprint",
			toolID:       "jira",
			method:       "POST",
			path:         "/rest/agile/1.0/sprint",
			query:        "",
			expectedType: "TICKET.CREATE",
			expectedRisk: RiskLow,
			expectedSum:  "Create sprint",
		},
		{
			name:         "jira agile move issues to sprint",
			toolID:       "jira",
			method:       "POST",
			...
			expectedType: "TICKET.UPDATE",
			expectedRisk: RiskLow,
			expectedSum:  "Move issues to sprint",
		},
		{
			name:         "jira agile delete sprint",
			toolID:       "jira",
			method:       "DELETE",
			path:         "/rest/agile/1.0/sprint/42",
			query:        "",
			expectedType: "DATA.DELETE",
			expectedRisk: RiskCritical,
			expectedSum:  "Delete sprint",
		},
		{
